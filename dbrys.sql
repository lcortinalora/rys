...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-09-2021 a las 19:03:41
...
INSERT INTO `empleado` (`id`, `tipoempleado`, `nombre`, `apellidos`, `fechadenacimiento`, `tipodocumento`, `numeroidentificacion`, `cuidad`, `departamento`, `celular`, `email`, `fechaingreso`, `formacion`, `carrera`, `cargo`, `perfillaboral`, `idioma`, `licencia`, `cursodealtura`, `lineaservicio`) VALUES
(1, 'tecnico', 'luis armando', 'cortina lora', '1989-08-11', 'cedula', '114333648', 'cartagena', 'bolivar', '3188440494', 'luiscolora@gmail.com', '2021-09-08', 'profesional', 'ingeniero de sistema', 'cordinador', 'junior', 'ninguno', 'no', 'no', 'redes,electrvidad');
...
(10, 'LUIS', 'asdasdas', 'jkgjhgjh', 'hgkjghk', 'mesa3'),
